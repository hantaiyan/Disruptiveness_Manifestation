...
nbreg delay_year novelty_n_p author_count first_author_productivity team_productivity inter_coauthorship i.year i.field, vce(robust)
...
nbreg delay_year novelty_n_w_c author_count first_author_productivity team_productivity inter_coauthorship i.year i.field, vce(robust)
outreg2 using Supplementary_Table3.doc, append ctitle(Model 2) bdec(3) tdec(3) ///
addstat(Log-likelihood, e(ll), Wald chi2, e(chi2)) ///
addtext(Year FE, YES, Field FE, YES)


nbreg delay_year c.novelty##i.journal_tier_rc author_count first_author_productivity team_productivity inter_coauthorship i.year i.field, vce(robust)
