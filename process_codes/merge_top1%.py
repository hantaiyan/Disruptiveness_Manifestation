...
OUT_PATH = BASE_DIR / "data" / "all-top1.dta"
...
def load_and_merge_data(base_dir: Path, year: int, field: str) -> pd.DataFrame:
    ...
    delay_path   = base_dir / "results" / "top1" / f"{year}{field}_focal_top1_delay_years.csv"
    ...
    try:
        ...
        delay_df.rename(columns={'delay_years_to_top1': 'delay_year'}, inplace=True)
    except FileNotFoundError:
